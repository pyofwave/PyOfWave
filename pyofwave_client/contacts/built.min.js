...
define("../api/jquery-1.5.1", function(){});
...
define("../api/splitter", function(){});

define('../contacts/contacts.js',['sample/contacts', '../api/knockout-2.1.0', '../api/jquery-1.5.1', '../api/splitter'], function(contacts, ko) {
